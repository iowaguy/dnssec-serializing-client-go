...
func areRootKeysTrusted(dnsKeys []*dns.DNSKEY, anchor *bootstrap.TrustAnchor) (bool, error) {
...
func verifyDNSSECProofChain(chain *dns.Chain, target string, anchor *bootstrap.TrustAnchor) (bool, error) {
